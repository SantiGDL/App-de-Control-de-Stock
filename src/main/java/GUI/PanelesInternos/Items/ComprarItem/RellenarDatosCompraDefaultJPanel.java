...
public class RellenarDatosCompraDefaultJPanel extends javax.swing.JPanel {
    ...
    private final javax.swing.JTextArea descripcionProveedorArea = new javax.swing.JTextArea();
    ...
    private void configurarVista() {
        ...
        prepararTarjeta(ContenidoDatosCompra, new Dimension(790, 210));
        configurarDescripcionProveedorMultilinea();
        ...
        Contenido.setPreferredSize(new Dimension(820, 645));
    ...
    private void prepararTarjeta(JPanel panel, Dimension tamano) {
        if (panel instanceof PanelDeFondo fondo) fondo.quitarImagenDeFondo();
    ...
    private void configurarDescripcionProveedorMultilinea() {
        descripcionProveedorArea.setDocument(DescripcionProveedor.getDocument());
        descripcionProveedorArea.setEditable(false);
        descripcionProveedorArea.setLineWrap(true);
        descripcionProveedorArea.setWrapStyleWord(true);
        descripcionProveedorArea.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        descripcionProveedorArea.setBackground(new Color(242, 245, 249));
        descripcionProveedorArea.setForeground(new Color(35, 45, 58));
        descripcionProveedorArea.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(new Color(185, 196, 208), 1),
            new EmptyBorder(6, 8, 6, 8)
        ));
        descripcionProveedorArea.setPreferredSize(new Dimension(206, 62));

        if (ContenidoDatosProveedor.getLayout() instanceof javax.swing.GroupLayout layout) {
            layout.replace(DescripcionProveedor, descripcionProveedorArea);
        }
    }
