 ...
 * @author Santi-kun
 */
public class HistorialXProveedorJPanel extends javax.swing.JPanel {
 private Long proveedorId; 
 
    private void irAHistorialXProveedorPantalla2(Long provedorId){
        JPanel pantalla2 = new HistorialXProveedorPantalla2JPanel(proveedorId);
    ...
    private void cargarTablaProveedores() {
        ...
        public void mouseClicked(java.awt.event.MouseEvent e) {
            ...
            irAHistorialXProveedorPantalla2(proveedorId);
    ...
    private void initComponents() {
        ...
        Atras.setBackground(new java.awt.Color(255, 255, 204));
    ...
    private void AtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AtrasActionPerformed
        JPanel panelDeCatalogos = new PanelDeHistoriales();
        FramePrincipal frame = (FramePrincipal) javax.swing.SwingUtilities.getWindowAncestor(this);
